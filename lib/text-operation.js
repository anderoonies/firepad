...
firepad.TextOperation = (function () {
  ...
  function TextOperation () {
    ...
    // Operations can be applied specific to a buffer, which is keyed on a string
    // of its filename. TextOperations with that key will affect only Firepad instances
    // with that filename.
    // The active file is managed in Firepad, and the TextOperation just gets it from there.
    this.filename = null;
